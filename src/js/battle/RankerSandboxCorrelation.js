        ...
        for (var n = 0; n < iterations; n++) {
          for (var i = 0; i < rankCount; i++) {
            ...
            for (var j = 0; j < matches.length; j++) {
              var sc = Math.sqrt(
                matches[j].rating * Math.pow(rankings[j].scores[n], 2)
              );
            ...
            rankings[i].scores.push(
              Math.floor(Math.sqrt(score / matches.length))
            );
          }
        }
              ...
              if (rankings[n].rating > 400) {
                ...
                for (var j = 0; j < rankings.length; j++) {
                  var correlation =
                    1000 -
                    Math.abs(
                      rankings[i].matches[j].rating -
                        rankings[n].matches[j].rating
                    );
