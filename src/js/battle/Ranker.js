    ...
    function rankerObject() {
      ...
      this.rank = function(league, shields) {
          ...
          if (gm.data.pokemon[i].fastMoves.length > 0) {
            ...
            if (stats >= minStats) {
              ...
              if (
                ...
                allowedList.indexOf(pokemon.speciesId) == -1
              ) {
                continue;
              }
              ...
              if (
                cup.name == "rainbow" &&
                (pokemon.dex > 251 || pokemon.speciesId.indexOf("alolan") > -1)
              ) {
                continue;
              }
        ...
        for (var i = 0; i < rankCount; i++) {
          ...
          var fastMovePercentage =
            rankings[i].moves.fastMoves[0].uses / rankings.length;

          if (fastMovePercentage < 0.5) {
            rating *= Math.pow(fastMovePercentage, 0.125);
          }
        ...
        for (var n = 0; n < iterations; n++) {
          for (var i = 0; i < rankCount; i++) {
            ...
            for (var j = 0; j < matches.length; j++) {
              ...
              if (fastMovePercentage < 0.5) {
                sc *= Math.pow(fastMovePercentage, 0.125);
              }
        ...
        for (var i = 0; i < rankCount; i++) {
          ...
          for (
            var j = rankObj.matches.length - 1;
            j > rankings[i].matches.length - matchupCount - 1;
            j--
          ) {
