        ...
        for (var i = 0; i < rankings.length; i++) {
          ...
          var $el = $(
            '<div class="rank ' +
              ...
              '" data="' +
              pokemon.speciesId +
              '"><div class="expand-label"></div><div class="name-container"><span class="number">#' +
              (i + 1) +
              ...
              r.score +
              '</span></div><div class="clear"></div></div><div class="details"></div>'
          );
          ...
          if (get.hasOwnProperty(key)) {
            ...
            switch (key) {
              ...
              case "cat":
                ...
                $('.ranking-categories a[data="' + val + '"]').addClass(
                  "selected"
                );
                break;
      ...
      function selectPokemon(e) {
        ...
        if (r.scores) {
          ...
          for (var i = 0; i < r.scores.length; i++) {
            var $item = $(
              '<div class="rating-container"><div class="ranking-header">' +
                categories[i] +
        ...
        $details.append(
          '<div class="detail-section float margin"><div class="ranking-header">Fast Moves</div><div class="ranking-header right">Usage</div><div class="moveset fast clear"></div></div><div class="detail-section float"><div class="ranking-header">Charged Moves</div><div class="ranking-header right">Usage</div><div class="moveset charged clear"></div></div><div class="detail-section float margin">	<div class="ranking-header">Key Matchups</div><div class="ranking-header right">Battle Rating</div><div class="matchups clear"></div></div><div class="detail-section float"><div class="ranking-header">Top Counters</div><div class="ranking-header right">Battle Rating</div><div class="counters clear"></div></div><div class="clear"></div><div class="share-link detail-section"><input type="text" readonly><div class="copy">Copy</div></div></div>'
        );
        ...
        for (var n = 0; n < fastMoves.length; n++) {
          var percentStr =
            Math.floor((fastMoves[n].uses / totalFastUses) * 1000) / 10 + "%";
          var displayWidth =
            Math.floor((fastMoves[n].uses / totalFastUses) * 1000) / 20;
          ...
          $details
            ...
            .append(
              '<div class="rank ' +
                ...
                '</span></div></div><div class="rating-container"><div class="rating" style="width:' +
                displayWidth +
                '">' +
                percentStr +
        ...
        for (var n = 0; n < chargedMoves.length; n++) {
          percentStr =
            Math.floor((chargedMoves[n].uses / totalChargedUses) * 1000) / 10 +
            "%";
          displayWidth =
            Math.floor((chargedMoves[n].uses / totalChargedUses) * 1000) / 20;
        ...
        if ($(".cup-select").length > 0) {
          ...
          $details
            ...
            .before(
              $(
                '<div class="multi-battle-link"><p>See all of <b>' +
                  pokemon.speciesName +
                  '\'s</b> matchups:</p><a target="_blank" class="button" href="' +
                  multiBattleLink +
                  '">' +
                  pokemon.speciesName +
                  " vs. " +
