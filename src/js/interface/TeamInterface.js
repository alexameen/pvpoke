  ...
  function createInstance() {
    ...
    function interfaceObject() {
      ...
      this.init = function() {
        ...
        $("body").on(
          "click",
          ".alternatives-table .button.add",
          addAlternativePokemon
        );
            ...
            switch (key) {
              ...
              case "t":
                ...
                for (var i = 0; i < list.length; i++) {
                  ...
                  pokemon.selectMove(
                    "fast",
                    pokemon.fastMovePool[arr[0]].moveId,
                    0
                  );
      ...
      this.updateTeamResults = function() {
        ...
        for (var i = 0; i < team.length; i++) {
          ...
          offenseArr.push({
            ...
            matchups: this.getTypeEffectivenessArray(
              [poke.fastMove.type],
              "offense"
            )
          });
        ...
        for (var n = 0; n < team.length; n++) {
          $row
            .find("tr")
            .append('<td class="name-small">' + team[n].speciesName + "</td>");
        ...
        for (var i = 0; i < 10; i++) {
          ...
          for (var n = 0; n < r.matchups.length; n++) {
            var $cell = $(
              '<td><a class="rating" href="#" target="blank"><span></span></a></td>'
            );
        ...
        for (var i = 0; i < 20; i++) {
          ...
          $row = $(
            '<tr><th class="name"><b>' + pokemon.speciesName + "</b></th></tr>"
          );
        ...
        for (var n = 0; n < counterTeam.length; n++) {
          $row
            .find("tr")
            .append(
              '<td class="name-small">' + counterTeam[n].speciesName + "</td>"
            );
        }
      ...
      this.getTypeEffectivenessArray = function(subjectTypes, direction) {
        ...
        for (var n = 0; n < allTypes.length; n++) {
          if (direction == "offense") {
            var effectiveness = battle.getEffectiveness(subjectTypes[0], [
              allTypes[n]
            ]);
      ...
      this.generateSummaries = function(defenseArr, offenseArr) {
        ...
        defenseSumArr = this.generateTypeSummary(
          defenseArr,
          defenseSumArr,
          "defense"
        );
        ...
        offenseSumArr = this.generateTypeSummary(
          offenseArr,
          offenseSumArr,
          "offense"
        );
      ...
      this.generateTypeSummaryList = function(arr, beforeStr, afterStr) {
        ...
        for (var i = 0; i < arr.length; i++) {
          ...
          str +=
            ' <span class="' + arr[i].toLowerCase() + '">' + arr[i] + "</span>";
        }
      ...
      function addAlternativePokemon(e) {
        ...
        $('.modal .poke-select option[value="' + id + '"]').prop(
          "selected",
          "selected"
        );
        $(".modal .poke-select").trigger("change");
        $("html, body").animate(
          { scrollTop: $(".poke.multi").offset().top },
          500
        );
      }
